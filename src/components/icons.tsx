// Lightweight stroke icon set (no dependency). 1.75 stroke, currentColor.
import type { ReactNode, SVGProps } from 'react'

type P = SVGProps<SVGSVGElement> & { size?: number }

/** Shared icon component type for navigation + UI props. */
export type IconType = (props: P) => JSX.Element
